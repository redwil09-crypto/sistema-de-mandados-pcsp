                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
                        <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-white/10 rounded-3xl w-full max-w-md p-6 shadow-tactic space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1"><label className="text-[10px] font-black text-text-muted uppercase tracking-widest text-[lime]">Circunstanciado (O que, Por que, Onde)</label><textarea className="w-full bg-background-light dark:bg-white/5 border border-border-light dark:border-lime-500/30 rounded-xl p-3 text-sm text-text-light dark:text-white min-h-[80px] focus:ring-1 focus:ring-lime-500" placeholder="Ex: CAPTURA DO RÉU EM SUA RESIDÊNCIA APÓS VIGILÂNCIA..." value={finalizeFormData.details} onChange={e => { const v = e.target.value; setFinalizeFormData(prev => ({ ...prev, details: v, fulfillmentSource: /PM\b|GCM\b|Polícia Militar|Guarda Civil|Polícia Civil|policia militar|guarda civil|policia civil|delegacia|plantão|plantao|terceiros|outra equipe|de fora|fora/i.test(v) ? 'external' : prev.fulfillmentSource })); }} /></div>
                                <div className="space-y-1">
