        ...
        <div className="min-h-screen pb-20 relative">
            ...
            <main className="px-4 py-2 space-y-6">
                <div className="grid grid-cols-2 gap-3">
                    <Link to="/warrant-list" className="group flex flex-col gap-3 rounded-2xl bg-surface-light p-4 shadow-md transition-all active:scale-[0.98] dark:bg-zinc-900 border border-transparent hover:border-blue-500 hover:shadow-[0_0_25px_rgba(59,130,246,0.6)]">
                    ...
                    <Link to="/minor-search" className="group flex flex-col gap-3 rounded-2xl bg-surface-light p-4 shadow-md transition-all active:scale-[0.98] dark:bg-zinc-900 border border-transparent hover:border-orange-500 hover:shadow-[0_0_25px_rgba(249,115,22,0.6)]">
                    ...
                    <Link to="/new-warrant" className="group flex flex-col gap-3 rounded-2xl bg-surface-light p-4 shadow-md transition-all active:scale-[0.98] dark:bg-zinc-900 border border-transparent hover:border-green-500 hover:shadow-[0_0_25px_rgba(34,197,94,0.6)]">
                    ...
                    <Link to="/stats" className="group flex flex-col gap-3 rounded-2xl bg-surface-light p-4 shadow-md transition-all active:scale-[0.98] dark:bg-zinc-900 border border-transparent hover:border-yellow-500 hover:shadow-[0_0_25px_rgba(234,179,8,0.6)]">
                    ...
                    <Link to="/route-planner" className="group flex flex-col gap-3 rounded-2xl bg-surface-light p-4 shadow-md transition-all active:scale-[0.98] dark:bg-zinc-900 border border-transparent hover:border-cyan-500 hover:shadow-[0_0_25px_rgba(6,182,212,0.6)] relative">
                    ...
                    <Link to="/ai-assistant" className="group flex flex-col gap-3 rounded-2xl bg-gradient-to-br from-blue-500/5 to-cyan-500/10 p-4 shadow-sm transition-all active:scale-[0.98] dark:from-zinc-900 dark:to-zinc-800 border border-blue-500/30 hover:border-blue-500 hover:shadow-[0_0_25px_rgba(59,130,246,0.6)]">
