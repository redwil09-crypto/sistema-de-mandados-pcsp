...
export async function inferDPRegion(address: string, lat?: number, lng?: number): Promise<string | null> {
    ...
    const prompt = `
        ...
        4. O MAPEAMENTO DE BAIRROS DE JACAREÍ É DESTRITO ABAIXO. VOCÊ DEVE SEGUIR ESTA TABELA:
            * 1º DP: CIDADE SALVADOR, MIRANTE DO VALE, ALTOS DE SANTANA, COLONIA, INDUSTRIAS, MARQUES, JARDIM DO VALE, DORA, MARIA AMELIA, OLYMPIA, PARAISO, JARDIM REAL, PEDREGULHO, SANTA MARINA, SANTO ANTONIO, YOLANDA, VILLA BRANCA, VILA BRANCA, PARQUE CALIFORNIA, PARQUE DOS PRINCIPES, ITAMARATI, SANTA PAULA, RIO COMPRIDO, SAO JUDAS, VILA ZEZE, VILA VINTEM, NOVO AMANHECER, PORTAL, PANORAMA, DIDINHA, CENTRO.
            * 2º DP: BANDEIRA BRANCA, BELA VISTA, CEREJEIRA, GUANABARA, IGARAPES, SANTA MARIA, CIDADE NOVA, LAGO DOURADO, LAGOINHA, ESCADA, LUIZA, JARDIM SANTANA, SAO LUIZ, PARATEI, AGRINCO, IMPERIAL, JEQUITIBA, SAO SILVESTRE, IJAL, IRAJA, NOVA ESPERANÇA, SAO JOAQUIM.
            * 3º DP: ZEZE, PRINCIPES, PARAIBA, SANTA MARINA, VILA GARCIA, PINHEIRO, SAO JOAO, SAO SIMAO, MARILIA, BRASILIA, BOA VISTA, ESPER, GUARANI, SAO GABRIEL, CALIFORNIA, SAO SILVESTRE, LOURDES, EMIDA COSTA, LEONIDIA, PITORESCO, VILA REAL, AMPARO.
            * 4º DP: REMEDIOS, REMEDINHO, PARATEI, LAGOINHA, PAGADOR, ANDRADE, MEIA LUA, PRIMEIRO DE MAIO, RIO ABAIXO, LAGOA AZUL.
        5. Se for comprovadamente em Jacareí, verifique em qual lista o bairro se encontra e retorne o DP correspondente. Se o bairro não estiver listado, use "1DP" como fallback (Centro/Geral).
