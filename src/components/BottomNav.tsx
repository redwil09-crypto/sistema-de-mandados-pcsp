    ...
    return (
        <nav className="fixed bottom-4 left-4 right-4 z-50 rounded-2xl border border-border-light dark:border-white/5 bg-surface-light dark:bg-surface-dark/80 backdrop-blur-lg shadow-glass pb-safe">
            <div className="flex h-16 w-full items-center justify-center gap-8 px-2">
                <Link to="/" className={`relative flex flex-col items-center justify-center gap-1 w-14 h-14 rounded-xl transition-all ${isActive('/') ? 'text-indigo-600 dark:text-white bg-indigo-500/20 shadow-[0_0_20px_rgba(99,102,241,0.3)] border border-indigo-500/30' : 'text-indigo-400/70 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-500/10 hover:drop-shadow-[0_0_5px_rgba(129,140,248,0.5)]'}`}>
                ...
                {isAdmin && (
                    <Link to="/audit" className={`relative flex flex-col items-center justify-center gap-1 w-14 h-14 rounded-xl transition-all ${isActive('/audit') ? 'text-emerald-600 dark:text-emerald-400 bg-emerald-500/20 shadow-[0_0_15px_rgba(52,211,153,0.3)] border border-emerald-500/30' : 'text-text-secondary-light dark:text-text-secondary-dark hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-500/10 hover:drop-shadow-[0_0_5px_rgba(52,211,153,0.5)]'}`}>
                ...
                <Link to="/profile" className={`relative flex flex-col items-center justify-center gap-1 w-14 h-14 rounded-xl transition-all ${isActive('/profile') ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-500/20 shadow-[0_0_15px_rgba(99,102,241,0.3)] border border-indigo-500/30' : 'text-text-secondary-light dark:text-text-secondary-dark hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-500/10 hover:drop-shadow-[0_0_5px_rgba(99,102,241,0.5)]'}`}>
