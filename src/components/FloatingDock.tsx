...
const FloatingDock = ({
    ...
    return (
        <nav className="fixed bottom-2 left-0 right-0 z-[999] px-4 animate-in slide-in-from-bottom duration-500 pointer-events-none">
            <div className="max-w-4xl mx-auto rounded-xl border border-white/5 bg-[#0a0a0c]/90 backdrop-blur-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.8)] px-2 pointer-events-auto">
                <div className="flex h-14 w-full items-center justify-around gap-1">
                    ...
                    {onDelete && (
                        <button
                            onClick={onDelete}
                            className="relative flex flex-col items-center justify-center gap-0.5 w-16 h-full transition-all text-zinc-500 hover:text-red-500 group"
                        >
