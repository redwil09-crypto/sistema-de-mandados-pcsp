...
const FloatingDock = ({ onBack, onHome, onSave, onPrint, onFinalize, onDelete, className }: FloatingDockProps) => {
    const containerClasses = className || "w-full z-10 rounded-3xl border border-border-light dark:border-white/10 bg-slate-200/95 dark:bg-black/95 backdrop-blur-xl shadow-glass transition-all duration-300 px-4 py-4 mt-8 mb-2";
